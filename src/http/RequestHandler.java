	...
	public void run() {
		try {
			...
			if ("GET".equals(tokens[0])) {
				...
				resonese400Error(outputStream, tokens[2]);
				/*
				 * HTTP1.0 400 Bad Request/r/n
...
//			outputStream.write("<h1>이 페이지가 잘 보이면 실습과제 SimpleHttpServer를 시작할 준비가 된 것입니다.</h1>".getBytes("UTF-8"));
	...
	private void resonese400Error(OutputStream outputStream, String url) throws IOException {
